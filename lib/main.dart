...
class _MyHomePageState extends State<MyHomePage> {
  // Method channel name
  static const platform = MethodChannel('com.example.fcm_demo/locationService');
...
// }
// @pragma('vm:entry-point')
// Future<void> _onAppOpen(RemoteMessage message) async{
//   // await Firebase.initializeApp();
//   print("inisde _onAppOpen function");
//   //await _loadCurrentAddress();
// }
// Future<void> _loadCurrentAddress() async {
//   String address = await Locationservices.checkLocation();
//   print("inisde _location function");
//   print(address);
//   // setState(() {
...
//   await _checkLocationPermission(); // Call the permission check here
//
//   //await initializeService();
//   runApp(const MyApp());
// }
...
//     const String officeNetworkUrl = 'http://10.0.3.135:8080/api/device-token';
//     const String homeNetworkUrl = 'http://192.168.0.8:8080/api/device-token';
//
